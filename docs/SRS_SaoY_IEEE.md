...
| 2 | Thư ký | Thực hiện đối chiếu thực tế bản chính và bản photocopy, sau đó tích chọn đầy đủ checklist bắt buộc của loại giấy tờ tương ứng (xem chi tiết ở mục 4.2.1.1). |
